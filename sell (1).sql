...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2020 at 07:10 PM
...
(3, 'browser', 'Windows 10', 3693, 0, NULL),
...
(176, 'no66517sJq', 'normal', NULL, 13, 4, 2, NULL, '{\"warranty_type\":{\"values\":[\"Local seller warranty\",\"No warranty\",\"international manufacturer warranty\",\"Non-local warranty\"],\"prices\":[\"10\",\"45\",\"0\",\"46\"],\"details_status\":1},\"brand\":{\"values\":[\"Symphony\",\"Oppo\",\"EStore\",\"Infinix\",\"Apple\"],\"prices\":[\"43\",\"10\",\"15\",\"3\",\"14\"],\"details_status\":1},\"ram\":{\"values\":[\"1 GB\",\"2 GB\",\"3 GB\"],\"prices\":[\"10\",\"20\",\"30\"],\"details_status\":1},\"color_family\":{\"values\":[\"Black\",\"White\",\"Sliver\",\"Red\",\"Dark Grey\",\"Dark Blue\",\"Brown\"],\"prices\":[\"10\",\"23\",\"30\",\"55\",\"65\",\"75\",\"85\"],\"details_status\":1}}', 'Zain - Digital Agency auu', 'zain-digital-agency-auu-no66517sjq', '1570876547aaQJLAun.png', '1570876547rJBVu8AQ.jpg', NULL, 'Small,Medium,Large,Extra Large', '95,100,100,100', '2,3,4,5', '#000000,#9f2cc7,#5722c7,#30ede2,#bfba39', 56, 4646, 'dsg', 341, 'sdg', 1, 242, NULL, NULL, NULL, 0, '5 Days', 0, NULL, NULL, 'https://www.youtube.com/watch?v=MIJBxqzazeM', 'Physical', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 1, 1, 1, 1, 1, '2019-10-12 04:35:47', '2020-04-11 08:41:33', 1, '02/20/2020', '10,20,30,40,50,60', '5,10,15,20,25,30', 0, 0, 0, 0, '');
INSERT INTO `products` (`id`, `sku`, `product_type`, `affiliate_link`, `user_id`, `category_id`, `subcategory_id`, `childcategory_id`, `attributes`, `name`, `slug`, `photo`, `thumbnail`, `file`, `size`, `size_qty`, `size_price`, `color`, `price`, `previous_price`, `details`, `stock`, `policy`, `status`, `views`, `tags`, `features`, `colors`, `product_condition`, `ship`, `is_meta`, `meta_tag`, `meta_description`, `youtube`, `type`, `license`, `license_qty`, `link`, `platform`, `region`, `licence_type`, `measure`, `featured`, `best`, `top`, `hot`, `latest`, `big`, `trending`, `sale`, `created_at`, `updated_at`, `is_discount`, `discount_date`, `whole_sell_qty`, `whole_sell_discount`, `is_catalog`, `catalog_id`, `area_id`, `brand_id`, `deal_code`) VALUES
...
--
ALTER TABLE `product_clicks`
  MODIFY `id` int(191) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=553;
