...
(function($) {
    ...
    $.fn.simpleCropper = function() {
        ...
        var ias = null;
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput'/><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><br><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div>";
