...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__("Pending Products")); ?></h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="<?php echo e(route('admin-prod-pending')); ?>"><?php echo e(__("Deactivated Products")); ?></a>
											</li>
										</ul>
								</div>
							</div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-prod-pending-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'type', name: 'type' },
