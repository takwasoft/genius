...
<?php $__env->startSection('content'); ?>  
          <div class="content-area">
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Tickets')); ?></h4>
                    <ul class="links">
                      <li>
                        <a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a>
                      </li>
                      <li>
                        <a href="javascript:;"><?php echo e(__('Messages')); ?></a>
                      </li>
                      <li>
                        <a href="javascript:;"><?php echo e(__('Tickets')); ?></a>
                      </li>
  ...
  <div class="modal-header d-block text-center">
    <h4 class="modal-title d-inline-block"><?php echo e(__('Confirm Delete')); ?></h4>
      ...
      <div class="modal-body">
            <p class="text-center"><?php echo e(__('You are about to delete this Ticket. Every messages under this Ticket will be deleted.')); ?></p>
...
<?php $__env->startSection('scripts'); ?>
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-message-datatables','Ticket')); ?>',
               columns: [
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
          '<a class="add-btn" href="javascript:;" data-toggle="modal" data-target="#vendorform"><i class="fas fa-envelope"></i> <?php echo e(__('Add Ticket')); ?></a>'+'</div>');
      });                       
