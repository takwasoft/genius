...
<?php $__env->startSection('content'); ?>  
					<input type="hidden" id="headerdata" value="<?php echo e(__('PAYMENT')); ?>">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__('Payment Gateways')); ?></h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="<?php echo e(route('admin-payment-index')); ?>"><?php echo e(__('Payment Gateways')); ?></a>
											</li>
										</ul>
								</div>
							</div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="<?php echo e(route('admin-payment-create')); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
          '<i class="fas fa-plus"></i> <?php echo e(__('Add New Payment')); ?>'+
          '</a>'+
          '</div>');
      });												
