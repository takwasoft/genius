								...
								<ul>
									...
									<li class="login">
										<a href="<?php echo e(route('user.login')); ?>" class="sign-log">
											<div class="links">
												<span class="sign-in">login</span> <span>|</span>
												<span class="sign-in">Register</span> <span>|</span>
				...
				<div class="input-group">
					<span class="input-group-btn"style=" border-radius: 50px;border-top-right-radius: 0; border-bottom-right-radius: 0;background: #e2dede;">
						<button class="btn " type="button">
							<a href="basket.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
						</button>
						
					</span>
					<div class="cart-text" style="padding-top: 7px; width: 72%;text-align: center;border: 1px solid #d0d0d2;"><span>2 items | $</span> 600.00</div>
					<span class="input-group-btn" style=" border-radius: 50px;border-top-left-radius: 0; border-bottom-left-radius: 0;background: #e2dede;">
						<button class="btn" type="button">
							<span><a href="customer-wishlist.html"><i class="fa fa-heart " aria-hidden="true"></i></a></span>
						</button>
					</span>
				</div>
				</div>
	...
	<!-- start brand area  --->
	 <div id="brand-area mb-2">
            <div class="container">
                <div class="row mb-3">
					<div class="col-md-4">
                    <a href="index.html"><img src="<?php echo e(asset('assets/images/brand/logo.jpg')); ?>" alt="" width="90%" /></a>
                </div>
                <div class="col-md-4">
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							<li><a href="<?php echo e(route('front.add_product')); ?>">Add Product</a></li>
							...
							<li><a href="<?php echo e(route('front.contact')); ?>" style="color:#333;font-weight:400"><?php echo e($langg->lang20); ?></a></li>
							<?php endif; ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-4">
						...
						<img src="<?php echo e(asset('assets/images/brand/bkash.png')); ?>" alt="" width="25%">
						<img src="<?php echo e(asset('assets/images/brand/cash_on_delivery.png')); ?>" alt="" width="25%">
				</div>
				<div class="col-md-6 col-lg-4 ">
