...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e($langg->lang444); ?></h4>
										<ul class="links">
											<li>
                        ...
                        <?php echo $__env->make('includes.vendor.form-success', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        <th><?php echo e($langg->lang608); ?></th>
									                        <th><?php echo e($langg->lang609); ?></th>
									                        <th><?php echo e($langg->lang610); ?></th>
									                        <th><?php echo e($langg->lang611); ?></th>
															<th>Promotion</th>
									                        <th><?php echo e($langg->lang612); ?></th>
														</tr>
													</thead>
												</table>
										</div>
										...
										<div class="modal-content">
											...
											<button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e($langg->lang613); ?></button>
											</div>
										</div>
										</div>
</div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
		<h4 class="modal-title d-inline-block"><?php echo e($langg->lang614); ?></h4>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			</button>
	</div>
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center"><?php echo e($langg->lang615); ?></p>
            <p class="text-center"><?php echo e($langg->lang616); ?></p>
      </div>

      <!-- Modal footer -->
      <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e($langg->lang617); ?></button>
            <a class="btn btn-danger btn-ok"><?php echo e($langg->lang618); ?></a>
      </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('vendor-prod-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'type', name: 'type' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="<?php echo e(route('vendor-prod-physical-create')); ?>">'+
          '<i class="fas fa-plus"></i> <span class="remove-mobile"><?php echo e($langg->lang623); ?><span>'+
          '</a>'+
          '</div>');
      });											
