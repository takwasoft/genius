...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__("Pending Verifications")); ?></h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="<?php echo e(route('admin-vr-index')); ?>"><?php echo e(__("Pending Verifications")); ?></a>
											</li>
										</ul>
								</div>
							</div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-vr-datatables','Pending')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
