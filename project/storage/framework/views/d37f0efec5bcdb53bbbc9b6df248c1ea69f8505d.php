                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="<?php echo e(route('vendor-service-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="input-field" name="details" placeholder="<?php echo e($langg->lang514); ?>"><?php echo e($data->details); ?></textarea> 
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn" type="submit"><?php echo e($langg->lang516); ?></button>
                          </div>
                        </div>
                      </form>
