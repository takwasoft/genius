								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks <?php echo e($gs->is_currency== 1 ? 'drop-success' : 'drop-danger'); ?>">
	                                      <option data-val="1" value="<?php echo e(route('admin-gs-iscurrency',1)); ?>" <?php echo e($gs->is_currency == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
	                                      <option data-val="0" value="<?php echo e(route('admin-gs-iscurrency',0)); ?>" <?php echo e($gs->is_currency == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
	                                    </select>
	                                  </div>
								</div>  
