							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="<?php echo e(route('admin-prod-index')); ?>"><?php echo e(__("Catalog Products")); ?></a>
											</li>
										</ul>
								</div>
							</div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
		<h4 class="modal-title d-inline-block"><?php echo e(__("Remove Catalog")); ?></h4>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			</button>
	</div>
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center"><?php echo e(__("You are about to remove this Product from Catalog.")); ?></p>
      ...
      <div class="modal-footer justify-content-center">
            ...
            <a class="btn btn-danger btn-ok"><?php echo e(__("Remove")); ?></a>
      </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-prod-catalog-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'type', name: 'type' },
