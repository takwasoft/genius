    ...
    <div class="row row-cards-one">
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    ...
                    <a href="<?php echo e(route('admin-order-pending')); ?>" class="link"><?php echo e(__('View All')); ?></a>
                </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    ...
                    <a href="<?php echo e(route('admin-order-processing')); ?>" class="link"><?php echo e(__('View All')); ?></a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    ...
                    <a href="<?php echo e(route('admin-order-completed')); ?>" class="link"><?php echo e(__('View All')); ?></a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
         ...
         <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                <div class="left">
                    <h5 class="title"><?php echo e(__('Total Sell!')); ?></h5>
                    <span class="number"><?php echo e($totalSell); ?></span>
                    <a href="<?php echo e(route('admin-order-paid')); ?>"  class="link"><?php echo e(__('View All')); ?></a>
                </div> 
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar"></i>
                                ...
                                <div class="table-responsiv  dashboard-home-table">
                                    <table id="poproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo e(strlen(strip_tags($data->name)) > 50 ? substr(strip_tags($data->name),0,50).'...' : strip_tags($data->name)); ?></td>
