                    ...
                    <div class="product-description">
                      <div class="body-area">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks <?php echo e($gs->show_stock == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                      <option data-val="1" value="<?php echo e(route('admin-gs-stock',1)); ?>" <?php echo e($gs->show_stock == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                      <option data-val="0" value="<?php echo e(route('admin-gs-stock',0)); ?>" <?php echo e($gs->show_stock == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks <?php echo e($gs->is_messenger == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                      <option data-val="1" value="<?php echo e(route('admin-gs-messenger',1)); ?>" <?php echo e($gs->is_messenger == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                      <option data-val="0" value="<?php echo e(route('admin-gs-messenger',0)); ?>" <?php echo e($gs->is_messenger == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                          <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                  <h4 class="heading">
                                      <?php echo e(__('Messenger Code')); ?> *
                                  </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea  name="messenger"><?php echo e($gs->messenger); ?></textarea>
                                  </div>
                              </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea  name="home_youtube"><?php echo e($gs->home_youtube); ?></textarea>
                                  </div>
                              </div>
                            </div>
