      ...
      <div class="row">
         <div class="col-lg-12">
            <ul class="pages">
               ...
               <?php if(!empty($subcat)): ?>
               <li>
                  <a href="<?php echo e(route('front.category', [$cat->slug, $subcat->slug])); ?>"><?php echo e($subcat->name); ?></a>
               </li>
               <?php endif; ?>
               <?php if(!empty($childcat)): ?>
               <li>
                  <a href="<?php echo e(route('front.category', [$cat->slug, $subcat->slug, $childcat->slug])); ?>"><?php echo e($childcat->name); ?></a>
               </li>
               <?php endif; ?>
               <?php if(empty($childcat) && empty($subcat) && empty($cat)): ?>
               <li>
                  <a href="<?php echo e(route('front.category')); ?>"><?php echo e($langg->lang36); ?></a>
               </li>
               <?php endif; ?>
