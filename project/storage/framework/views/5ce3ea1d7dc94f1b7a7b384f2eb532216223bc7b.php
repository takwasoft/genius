                ...
                <form action="<?php echo e(URL::to('/')); ?>/<?php echo e($action); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo e($field['value']); ?>" <?php if($field["required"]): ?> required <?php endif; ?> name="<?php echo e($field['name']); ?>" type="text"
                                class="form-control">
                        </div>
                        <?php elseif($field["type"]=="date"): ?>
                        <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo e($field['label']); ?></label>
                                <input value="<?php echo e($field['value']); ?>" <?php if($field["required"]): ?>
                                    required
                                    <?php endif; ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo e($field['label']); ?></label>
                            <input <?php if($field["required"]): ?> required <?php endif; ?> name="<?php echo e($field['name']); ?>" type="text"
                                class="form-control">
                        </div>
                        <?php elseif($field["type"]=="checkbox"): ?>
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo e($field['label']); ?></label>
                            <input  <?php if($field["value"]==1): ?> checked <?php endif; ?> <?php if($field["required"]): ?> required <?php endif; ?> name="<?php echo e($field['name']); ?>" type="checkbox">
                        </div>
                        <?php elseif($field["type"]=="file"): ?>
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo e($field['label']); ?></label>
                            <input <?php if($field["required"]): ?> required <?php endif; ?> name="<?php echo e($field['name']); ?>" type="file"
