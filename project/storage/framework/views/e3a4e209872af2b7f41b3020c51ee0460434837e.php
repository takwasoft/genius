          ...
          <div class="user-profile-info-area">
            <ul class="links">
              ...
              <li class="<?php echo e($link == route('user-favorites') ? 'active':''); ?>">
                  <a href="<?php echo e(route('user-favorites')); ?>"><?php echo e($langg->lang231); ?>

                  <span class="<?php echo e($favCount>0?'badge badge-danger':''); ?>">
                  <?php echo e($favCount); ?>
              ...
              <li class="<?php echo e($link == route('user-messages') ? 'active':''); ?>">
                  <a href="<?php echo e(route('user-messages')); ?>"><?php echo e($langg->lang232); ?>
              ...
              <li class="<?php echo e($link == route('user-message-index') ? 'active':''); ?>">
                  <a href="<?php echo e(route('user-message-index')); ?>"><?php echo e($langg->lang204); ?>

                  <span class="<?php echo e($ticketCount>0?'badge badge-danger':''); ?>">
                  <?php echo e($ticketCount); ?>
