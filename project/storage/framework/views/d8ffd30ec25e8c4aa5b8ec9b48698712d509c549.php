            ...
            <div class="invoice__metaInfo">
                <div class="col-lg-6">
                    <div class="invoice__orderDetails">
                        ...
                        <?php endif; ?>
                        <span> <strong><?php echo e(__('Payment Method')); ?> :</strong> <?php echo e($order->method); ?></span><br>
                        <span><strong><?php echo e(__('Payment Status')); ?> :</strong> <?php echo e($order->payment_status == 'Pending' ? "Unpaid":"Paid"); ?></span>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <?php if($product['color']): ?>
                                                <p>
                                                        color : <span style="margin-left: 40px; width: 20px; height: 0.2px; display: block; border: 10px solid <?php echo e($product['color'] == "" ? "white" : $product['color']); ?>;"></span>
                                                </p>
                                                <?php endif; ?>
                                                <p>
                                                        Price : <?php echo e($order->currency_sign); ?><?php echo e(round($product['item']['price'] * $order->currency_value , 2)); ?>

                                                </p>
                                               <p>
                                                    Qty : <?php echo e($product['qty']); ?> <?php echo e($product['item']['measure']); ?>
