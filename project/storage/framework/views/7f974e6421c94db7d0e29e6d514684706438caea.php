...
<?php $__env->startSection('content'); ?>  
          <input type="hidden" id="headerdata" value="<?php echo e($langg->lang720); ?>">
          <div class="content-area">
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e($langg->lang721); ?></h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="<?php echo e(route('vendor-package-index')); ?>"><?php echo e($langg->lang721); ?></a>
                      </li>
                    </ul>
                </div>
              </div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  ...
  <div class="modal-header d-block text-center">
    <h4 class="modal-title d-inline-block"><?php echo e($langg->lang734); ?></h4>
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center"><?php echo e($langg->lang728); ?></p>
...
<?php $__env->startSection('scripts'); ?>
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('vendor-package-datatables')); ?>',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="<?php echo e(route('vendor-package-create')); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
          '<i class="fas fa-plus"></i> <?php echo e($langg->lang733); ?>'+
          '</a>'+
          '</div>');
      });                     
