...
<div class="content-area">
    ...
    <?php endif; ?> <?php echo $__env->make('includes.form-success', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                <div class="left">
                    ...
                    <span class="number"><?php echo e(App\Models\Product::vendorConvertPrice( App\Models\VendorOrder::with('order')->where('user_id','=',$user->id)->where('status','=','completed')->whereHas('order',function($q){
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                <div class="left">
                    ...
                    <span class="number"><?php echo e(round($user->current_balance,2)); ?></span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar-true"></i>
