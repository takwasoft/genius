        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="pages">
                    ...
                    @endif @if (empty($childcat) && empty($subcat) && empty($cat))
                    <li>
...
<script>
    ...
    function filter() {
        ...
        if ($("#prod_name").val() != '') {
            if (filterlink == '') {
                filterlink += '{{route('
                front.category ', [Request::route('
                category '), Request::route('
                subcategory '), Request::route('
                childcategory ')])}}' + '?search=' + $("#prod_name").val();
            } else {
        ...
        $(".attribute-input").each(function() {
            if ($(this).is(':checked')) {
                if (filterlink == '') {
                    ...
                    category '), Request::route('
                    subcategory '), Request::route('
                    childcategory ')])}}' + '?' + $(this).attr('name') + '=' + $(this).val();
                } else {
        ...
        if ($("#sortby").val() != '') {
            if (filterlink == '') {
                ...
                category '), Request::route('
                subcategory '), Request::route('
                childcategory ')])}}' + '?' + $("#sortby").attr('name') + '=' + $("#sortby").val();
            } else {
        ...
        if ($("#min_price").val() != '') {
            if (filterlink == '') {
                ...
                category '), Request::route('
                subcategory '), Request::route('
                childcategory ')])}}' + '?' + $("#min_price").attr('name') + '=' + $("#min_price").val();
            } else {
        ...
        if ($("#max_price").val() != '') {
            if (filterlink == '') {
                ...
                category '), Request::route('
                subcategory '), Request::route('
                childcategory ')])}}' + '?' + $("#max_price").attr('name') + '=' + $("#max_price").val();
            } else {
    ...
    function addToPagination() {
        ...
        $('ul.pagination li a').each(function() {
            ...
            category '),Request::route('
            subcategory '),Request::route('
            childcategory ')])}}?page=' + page + '&search=' + '{{request()->input('
            search ')}}';
    ...
    $(function() {
        ...
        $("#slider-range").slider({
            ...
            values: [{
                ...
                {
                    isset($_GET['max']) ? $_GET['max'] : '10000000'
                }
            }],
            step: 5,
