							...
							<ul class="list">
								...
								<li class="bell-area">
									<a id="notf_order" class="dropdown-toggle-1" href="javascript:;">
										...
										<span
											data-href="{{ route('vendor-order-notf-count',Auth::guard('web')->user()->id) }}"
					...
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
								<li>
									<a href="{{ route('select-area') }}"><span>{{ $langg->lang445 }}</span></a>
								</li>
								<li>
								...
								<li>
									<a
										href="{{ route('admin-vendor-catalog-index') }}"><span>{{ $langg->lang785 }}</span></a>
								</li>
							</ul>
						</li>
						...
						<li>
							<a href="{{ route('vendor-prod-import') }}"><i
									class="fas fa-upload"></i>{{ $langg->lang450 }}</a>
						</li>
						<li>
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
								...
								<li>
									<a
										href="{{ route('vendor-shipping-index') }}"><span>{{ $langg->lang719 }}</span></a>
								</li>
								@endif
