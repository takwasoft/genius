...
class CheckoutController extends Controller
{
    ...
    public function loadsubpayments($slug1, $slug2)
    {
        ...
        return view('load.payments', compact('subtitle', 'amount', 'extraCharges', 'curr', 'additionalFields', 'verificationFields'));
    }
    ...
    public function loadpayment($slug1, $slug2)
    {
        ...
        $extraCharges = ExtraChargeRule::where('payment_gateway_id', '=', $gateway->id)->get();
        return view('load.payment', compact('subtitle', 'extraCharges', 'payment', 'pay_id', 'gateway', 'curr', 'additionalFields', 'verificationFields', 'total'));
    }
