...
class CatalogController extends Controller
{
  ...
  public function category(Request $request, $slug = null, $slug1 = null, $slug2 = null)
  {
    ...
    $prods = $prods->where('status', '=', 1)->where(function ($query) use ($cat, $subcat, $childcat, $request) {
      $flag = 0;
  ...
  public function product($slug)
  {
    ...
    if ($productt->user_id != 0) {
      $vendors = Product::where('status', '=', 1)->where('user_id', '=', $productt->user_id)->take(6)->get();
    } else {
      $vendors = Product::where('status', '=', 1)->where('user_id', '=', 0)->take(6)->get();
    }
    $feature_products =  Product::where('status', '=', 1)->orderBy('id', 'desc')->take(6)->get();
