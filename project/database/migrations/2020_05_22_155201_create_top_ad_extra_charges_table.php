...
class CreateTopAdExtraChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('top_ad_extra_charges', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('top_ad_extra_charges');
    }
}
